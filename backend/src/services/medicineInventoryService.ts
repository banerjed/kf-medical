...
/**
 * Handles MedicineInventory operations
 */
export default class MedicineInventoryService {
  ...
  /**
   * Destroy all MedicineInventorys with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds the MedicineInventory by Id.
   *
   * @param {*} id
   */
  async findById(id) {
  ...
  /**
   * Finds MedicineInventorys for Autocomplete.
   *
   * @param {*} search
   * @param {*} limit
   */
  ...
  /**
   * Finds MedicineInventorys based on the query.
   *
   * @param {*} args
   */
  ...
  /**
   * Imports a list of MedicineInventorys.
   *
   * @param {*} data
   * @param {*} importHash
   */
