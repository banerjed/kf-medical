...
/**
 * Handles database operations for the MedicineEnum.
 * See https://sequelize.org/v5/index.html to learn how to customize it.
 */
class MedicineEnumRepository {
  /**
   * Creates the MedicineEnum.
   *
   * @param {Object} data
  ...
  static async update(id, data, options: IRepositoryOptions) {
    ...
    let record = await options.database.medicineEnum.findByPk(
      id,
      {
        transaction,
      },
  ...
  /**
   * Finds the MedicineEnum and its relations.
   *
   * @param {string} id
   * @param {Object} [options]
   */
  static async findById(id, options: IRepositoryOptions) {
    ...
    const record = await options.database.medicineEnum.findByPk(
      id,
      {
        include,
        transaction,
  ...
  /**
   * Counts the number of MedicineEnums based on the filter.
   *
   * @param {Object} filter
   * @param {Object} [options]
   */
  ...
  /**
   * Finds the MedicineEnums based on the query.
  ...
  /**
   * Lists the MedicineEnums to populate the autocomplete.
   * See https://sequelize.org/v5/manual/querying.html to learn how to
   * customize the query.
   *
   * @param {Object} query
  ...
  /**
   * Fills an array of MedicineEnum with relations and files.
   *
   * @param {Array} rows
   * @param {Object} [options]
   */
  ...
  /**
   * Fill the MedicineEnum with the relations and files.
   *
   * @param {Object} record
   * @param {Object} [options]
   */
